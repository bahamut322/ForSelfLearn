 ...
 */
class FinishRemoteOrderPutTask(taskModel: TaskModel, val type: Int, var exceptioned: Boolean = false, needReportData: Boolean = true) : AbstractTask(taskModel, needReportData) {
