...
class BasicConfig(
    ...
    @ColumnInfo(name = "app_version")var appVersion:String?,//App版本
    @ColumnInfo(name = "brightness") var brightness:Int?,//亮度
    @ColumnInfo(name = "send_speed")var sendSpeed:Float?,//速度
    ...
    @ColumnInfo(name = "guide_speed")var guideSpeed:Float?,//领速度
    ...
    @ColumnInfo(name = "wifi_open")var wifiOpen:Int?,//wifi打开
