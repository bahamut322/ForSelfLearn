package com.sendi.deliveredrobot.baidutts.util;
...
public class Auth {
    ...
    private synchronized Properties load(Context context) {
        try {
            String path = Environment.getExternalStorageDirectory().getPath() + "/config/auth.properties";
            File file = new File(path);
            CommonHelper.INSTANCE.checkAuthProperties(context, file);
