...
class CommonHandleExceptionHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    val textView: TextView = itemView.findViewById(R.id.tv)
    var data: CommonHandleExceptionModel? = null
        set(data) {
            val model = data
            ...
            if (selected!!) {
                textView.apply {
                    text = model.title
                    textSize = context.resources.getDimension(R.dimen.mid_text_size)
                ...
                textView.apply {
                    text = model.title
                    textSize = context.resources.getDimension(R.dimen.mid_small_small_text_size)
