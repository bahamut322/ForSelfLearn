...
import com.sendi.deliveredrobot.databinding.FragmentChooseSendPlaceBin2Binding
...
class ChooseSendPlaceBin2Fragment : Fragment() {
    private lateinit var binding: FragmentChooseSendPlaceBin2Binding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_choose_send_place_bin2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        MainScope().launch {
            if(sendPlaceBin2ViewModel.data.size == 0){
...
//                    it.floorCode
                ...
                sendPlaceBin2ViewModel.data = sortDataList
            }
            val fragments: Array<Fragment> = Array(sendPlaceBin2ViewModel.data.size) {
                SendPlaceBin2ListFragment(it)
            }
            binding.tabLayout.apply {
                ...
                for (data in sendPlaceBin2ViewModel.data) {
                    addTab(newTab().apply {
                            ...
                            MyApplication.instance!!.sendBroadcast(
                                Intent().apply {
                                    ...
                                    putExtra(NAVIGATE_BUNDLE,Bundle().apply {
                                        putInt(CHOOSE_BIN, CHOOSE_BIN2)
                                        putString(
                                            InputPasswordFromType.INPUT_PASSWORD_FROM_TYPE, arguments?.getString(
                                                InputPasswordFromType.INPUT_PASSWORD_FROM_TYPE))
                                    })
                                }
                            )
                        }
...
//                    sendPlaceBin2ViewModel.place.value = sendPlaceBin2ViewModel.getCurrentSelectedName()
                }
            }
        }
        ...
        binding.imageViewSquareClear.apply {
            setOnClickListener {
                sendPlaceBin2ViewModel.clearSelected()
            }
        }
        sendPlaceBin2ViewModel.place.observe(viewLifecycleOwner) {
...
//                        R.id.action_chooseSendPlaceBin2Fragment_to_putObjectFragment,
//                        Bundle().apply {
//                            putInt(CHOOSE_BIN, CHOOSE_BIN2)
//                        })
                    timer.cancel()
