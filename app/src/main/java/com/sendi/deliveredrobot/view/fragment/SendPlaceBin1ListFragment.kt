...
import com.sendi.deliveredrobot.adapter.SendPlaceBin1ListAdapter
...
class SendPlaceBin1ListFragment(position: Int) : Fragment() {
    private lateinit var binding: FragmentPlaceListBinding
    private val viewModel by viewModels<SendPlaceBin1ViewModel>({ requireActivity() })
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding.rvContainer) {
            ...
            adapter = SendPlaceBin1ListAdapter(viewModel, localPosition)
        }
