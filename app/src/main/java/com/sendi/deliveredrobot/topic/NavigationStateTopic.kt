                                    ...
                                    withContext(Dispatchers.Default) {
                                        point =
                                            dao.queryLiftPoint(
                                                ...
                                                elevator = BillManager.currentBill()?.currentTask()?.taskModel?.elevator?:""
                                            )
                                    }
                                    if(point!= null){
                                        if(ROSHelper.checkOutOfLift(point!!)){
                                            ...
                                            BillManager.currentBill()?.addRetryIntoLiftQueue(needHoldLiftDoor = false)
                                        }else{
                                            BillManager.currentBill()?.addRetryIntoLiftQueue(needHoldLiftDoor = true)
                                        }
                                    }
