...
class RoadMapAdapter: BaseRecyclerViewAdapter<RouteMap>{

    constructor(context: Context, data: List<RouteMap>?): super(context, data) {
    ...
    override fun bindView(holder: BaseRecyclerHolder, position: Int) {
        ...
        textViewMapName.apply {
            ...
            val laserFile = resources.getString(R.string.str_Road_Map_file)
    ...
    interface OnItemClickCallback {
        fun onItemClick(data: RouteMap, position: Int)
        fun onExportButtonClick(data: RouteMap, position: Int)
        fun onImportButtonClick(data: RouteMap, position: Int)
        fun onDeleteButtonClick(data: RouteMap, position: Int)
    }
