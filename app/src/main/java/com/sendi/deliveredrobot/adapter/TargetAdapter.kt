...
class TargetAdapter: BaseRecyclerViewAdapter<SubMap>{

    constructor(context: Context, data: List<SubMap>?): super(context, data) {
    ...
    override fun bindView(holder: BaseRecyclerHolder, position: Int) {
        ...
        textViewMapName.apply {
            ...
            val laserFile = resources.getString(R.string.str_target_file)
    ...
    interface OnItemClickCallback {
        fun onItemClick(data: SubMap, position: Int)
        fun onExportButtonClick(data: SubMap, position: Int)
        fun onImportButtonClick(data:SubMap, position: Int)
        fun onDeleteButtonClick(data:SubMap, position: Int)
    }
