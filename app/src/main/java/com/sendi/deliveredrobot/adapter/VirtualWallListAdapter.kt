 ...
 *   @describe: 虚拟墙列表
 */
class VirtualWallListAdapter : RecyclerView.Adapter<LimitSpeedListHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LimitSpeedListHolder {
        return LimitSpeedListHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_virtual_wall_list, parent, false)
        )
    }
