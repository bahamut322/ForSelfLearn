package com.sendi.fooddeliveryrobot.util
...
class HanziToPinyin constructor(private val mHasChinaCollator: Boolean) {
    class Token {
        constructor()
    ...
    companion object {
        ...
        val instance: HanziToPinyin?
            get() {
                synchronized(HanziToPinyin::class.java) {
                    ...
                    val locale: Array<Locale> = Collator.getAvailableLocales()
        ...
        private fun doSelfValidation(): Boolean {
            ...
            for (c in UNIHANS) {
                ...
                val cmp: Int = COLLATOR.compare(lastString, curString)
                if (cmp >= 0) {
                    Log.e(
