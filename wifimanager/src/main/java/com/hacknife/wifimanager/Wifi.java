...
//        wifi.isConnected = wifi.SSID.equals(connectedSSID) && ipAddress > 0;
        ...
        if (wifi.capabilities.toUpperCase().contains("WPA2") && wifi.capabilities.toUpperCase().contains("WPA")) {
            wifi.encryption = "WPA/WPA2";
        } else if (wifi.capabilities.toUpperCase().contains("WPA")) {
            wifi.encryption = "WPA";
        } else if (wifi.capabilities.toUpperCase().contains("WPA2")) {
